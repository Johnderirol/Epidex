 ...
 */
final class Version20210512152657 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comp_leader (id INT AUTO_INCREMENT NOT NULL, pole VARCHAR(255) NOT NULL, definition VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rating_leader DROP FOREIGN KEY FK_DA11805F73154ED4');
        ...
        $this->addSql('DROP TABLE comp_leader');
